;;; my-dockerfile.el --- dockerfile-mode configuration.
...
(use-package dockerfile-mode
  :hook
  (dockerfile-mode . my/dockerfile-mode-setup)

  :init
  (defun my/dockerfile-mode-setup ()
...
(provide 'my-dockerfile)
;;; my-dockerfile.el ends here
