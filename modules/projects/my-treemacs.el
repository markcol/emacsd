...
(use-package treemacs
  ...
  :hook
  (treemacs-mode . my/treemacs-change-hl-line-mode)
  ...
  (treemacs-persist-file (expand-file-name "treemacs-persist" my/cache-dir))
  (treemacs-last-error-persist-file
   (expand-file-name "treemacs-persist-at-last-error" my/cache-dir))

  :init

  (defface my/treemacs-line-highlight '((t (:extend t)))
    "Custom line-highlight face for treemacs.")

  (defun my/treemacs-change-hl-line-mode ()
    "Use a custom face to control style of highlighted line."
    (setq-local hl-line-face 'my/treemacs-line-highlight)
