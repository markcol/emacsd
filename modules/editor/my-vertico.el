;;; my-vertico.el --- vertico configuration. -*- lexical-binding: t; -*-
...
(use-package vertico-directory
  ...
  (with-eval-after-load 'projectile
    ...
    (defun my/vertico-projectile-completing-read (orig-fun &rest args)
      (if vertico-directory-mode
          (progn
    ...
    (advice-add 'projectile-completing-read :around
                'my/vertico-projectile-completing-read))
