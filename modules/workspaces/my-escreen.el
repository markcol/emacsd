;;; my-escreen.el --- escreen configuration.
...
(use-package escreen
  ...
  (:map escreen-map
        ...
        (";" . my/escreen-get-active-screen)
        ("C-;" . my/escreen-get-active-screen)
  ...
  :hook
  (escreen-goto-screen . my/escreen-get-active-screen)

  :init
  (defun my/escreen-get-active-screen ()
    "what the name says"
    (interactive)
