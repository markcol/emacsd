;;; myn-doom-themes-theme.el --- doom-themes. -*- lexical-binding: t; -*-
...
(deftheme my-doom-themes-overrides
  "Overrides for doom-themes.")

(custom-theme-set-faces
 'my-doom-themes-overrides
 ...
 `(my-diff-hl-insert ((t ( :foreground ,(doom-blend 'vc-added 'bg 0.7)
                              :background ,(doom-color 'bg)))))
 ...
 ;; treemacs
 `(my-treemacs-line-highlight ((t ( :background ,(doom-blend 'violet 'bg 0.2)
                                       :extend t ))))
...
(provide-theme 'my-doom-themes-overrides)
;;; my-doom-themes-overrides-theme.el ends here
